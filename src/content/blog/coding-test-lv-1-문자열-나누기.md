...
description: '프로그래머스 Lv.1 문자열 나누기 &nbsp; 문자열 s 가 입력되었을 때 다음 규칙을 따라서 이 문자열을 여러 문자열로 분해하려고 합니다. 먼저 첫 글자를 읽습니다. 이 글자를 x라고 합시다. 이제 이 문자열을'
pubDate: '2024-01-30 20:52 +0900'
author: 'Tag'
